...
class ComparatorOrdemNomeContato implements Comparator<Map.Entry<Integer, Contato>> {
    ...
    public int compare(Map.Entry<Integer, Contato> cont1, Map.Entry<Integer, Contato> cont2) {
        ...
        /*System.out.println("--\tOrdem número telefone\t--"); // Implementação com Classe Anônima
        ...
        /*System.out.println("--\tOrdem número telefone\t--"); // Implementação com Classe Anônima e Interface Function
